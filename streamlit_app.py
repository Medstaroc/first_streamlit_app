...
def update_dataset(utilisateur, mot_de_passe, selected_dataset, uploaded_file):
    # Code pour mettre à jour les jeux de données sur le portail de Nantes Métropole
    dataset_id = selected_dataset
    dataset_uid = get_dataset_uid(dataset_id, utilisateur, mot_de_passe)
...
def main():
    ...
    if not st.session_state.authenticated:
        ...
        if selected_dataset:
            ...
            if uploaded_file:
                update_response = update_dataset(utilisateur, mot_de_passe, selected_dataset, uploaded_file)
